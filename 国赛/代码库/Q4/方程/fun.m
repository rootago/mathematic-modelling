function objectiveA = fun(x)
    ...
    for i = 1:4:9
        ...
        [t_start1,t_end1] = eqn(t1,t2,v,theta,APos0(1,:),BPos0(j,:));
        [t_start2,t_end2] = eqn(t1,t2,v,theta,APos0(1,:),BPos0(j,:));

        times1 = [time1s;[t_start, t_end]];
        times2 = [time2s;[t_start, t_end]];
