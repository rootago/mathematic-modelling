...
'MaxGenerations', 500, ...        % 增加最大代数
'MaxStallGenerations', 100, ...   % 增加停滞代数
'MutationFcn', {@mutationuniform, 0.5},...  % 降低变异率
'CrossoverFcn', {@crossoverscattered}, ...   % 使用散点交叉
'SelectionFcn', {@selectiontournament, 4},... % 锦标赛选择
'EliteCount', 10, ...             % 增加精英个体数量
'FunctionTolerance', 1e-15, ...   % 更严格的函数容忍度
'ConstraintTolerance', 1e-6);     % 约束容忍度
